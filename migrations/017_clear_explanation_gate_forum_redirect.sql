ALTER TABLE clear_explanation_gate_state
  RENAME TO clear_explanation_gate_state_old;
...
SELECT
  ...
  created_at,
  updated_at
FROM clear_explanation_gate_state_old;

DROP TABLE clear_explanation_gate_state_old;
