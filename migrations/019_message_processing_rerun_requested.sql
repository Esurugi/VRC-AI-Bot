...
ALTER TABLE message_processing RENAME TO message_processing_legacy_rerun_requested;
...
SELECT
  ...
  updated_at,
  completed_at
FROM message_processing_legacy_rerun_requested;

DROP TABLE message_processing_legacy_rerun_requested;
